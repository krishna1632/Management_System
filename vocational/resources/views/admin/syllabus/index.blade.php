...
@section('content')
    ...
    <div class="card mb-4">
        <div class="card-header">
            ...
            Syllabus List
            <a href="{{ route('admin.syllabus.create') }}" class="btn btn-primary btn-sm float-end">Add New Syllabus</a>
        </div>
        <div class="card-body">
                ...
                <tbody>
                    @foreach ($syllabus as $material)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.syllabus.show', $material->id) }}"
                                    class="btn btn-info btn-sm">View</a>
                                <a href="{{ route('admin.syllabus.edit', $material->id) }}"
